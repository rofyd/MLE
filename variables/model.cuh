...
V = 1/2 m^2 phi^2 - 1/4 lambda phi^4 + g^2 /(6m^2) phi^6
...
inline void modelinfo(FILE *info_)
{
  ...
  fprintf(info_,"TODO\n");
  fprintf(info_,"V = 1/2 m^2 phi^2 - 1/4 lambda phi^4 + 1/6 g^2/m^2 phi^6\n\n");

  // Model specific parameter values
  fprintf(info_, "pmass = %f\n", pmass);
  fprintf(info_, "lm2 (lamda/m^2) = %f\n", param_1st);
